This is a springboot REST api for a to do list application. The application has been decoupled into the user interface and the application logic as well as database access
